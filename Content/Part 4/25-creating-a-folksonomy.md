...
As well as being a challenging code problem, the taxonomy implementation activity highlighted development process problems. Heavy discussion meant development dragged on. Some wanted to delay the release, others wanted to pull the feature, others wanted to revise the scheme in a subsequent version. Andy Skelton [responded to the wp-hackers discussion](http://lists.wordpress.org/pipermail/wp-hackers/2007-April/011988.html):
